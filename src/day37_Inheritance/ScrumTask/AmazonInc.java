...
public class AmazonInc {
    ...
    ProductOwner po = new ProductOwner("Joe", 29, 'M',1,160000, company);

    BusinessAnalyst ba = new BusinessAnalyst("Forrest", 30, 'M', 2, 150000, company);

    ScrumMaster sm = new ScrumMaster("Gump", 26, 'F', 3, 145000, company);



    Tester tester1=new Tester("Kyrie",32,'F',"QA",1415,125000,company);

    Tester tester2=new Tester("Duncan",31,'F', "QE",1416,130000,company);

    Tester tester3=new Tester("Irena",29,'F',"SDET",1417,128000,company);

    Tester tester4=new Tester("Sam",26,'M',"QA",1418,125000,company);
